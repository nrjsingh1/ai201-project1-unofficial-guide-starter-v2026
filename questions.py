...
QUESTIONS = [
    ...
    {"question": "I am using student account cloud drive for my personal files and I am graduating next month, how long my files are safe?", "expects": "Siz months after graduation"},
